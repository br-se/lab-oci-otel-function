...
ENV JAVA_TOOL_OPTIONS "-javaagent:/function/app/opentelemetry-javaagent.jar -Dotel.resource.attributes=service.name=hello-java -Dotel.instrumentation.opentelemetry-api.enabled=true -Dotel.instrumentation.opentelemetry-instrumentation-annotations.enabled=true"
